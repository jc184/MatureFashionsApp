...
namespace MatureFashionsApp.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(MatureFashionsContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ItemNo,ItemDescription,ItemGender,ItemColour,ItemSize,ItemWholesalePrice,ItemRetailPrice")] Item item)
        {
            if (id != item.ItemNo)
            {
                return NotFound();
        ...
        {
            return _context.Item.Any(e => e.ItemNo == id);
        }
    }
}
